    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1 class="regulaminH1">Dodaj grę</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                <form class="" action="{{route('library.store')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="form-group{{ ($errors->has('price_category')) ? $errors->first('price_category') : '' }}">
                        ...
                        <input type="number" id="price_category" name="price_category" class="form-control">
                    ...
                    <div class="form-group{{ ($errors->has('min_player_count')) ? $errors->first('min_player_count') : '' }}">
                        ...
                        <input type="number" id="min_player_count" name="min_player_count" class="form-control">
                    ...
                    <div class="form-group{{ ($errors->has('max_player_count')) ? $errors->first('max_player_count') : '' }}">
                        ...
                        <input type="number" id="max_player_count" name="max_player_count" class="form-control">
                    ...
                    <div class="form-group{{ ($errors->has('description')) ? $errors->first('description') : '' }}">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="10" cols="70" placeholder="Wpisz opis gry!"></textarea>
                        {!! $errors->first('description', '<p class="help-block">:message</p>') !!}
                    </div>
                    <div class="form-group{{ ($errors->has('genre')) ? $errors->first('genre') : '' }}">
                        <label for="genre">Gatunek gry </label>
                        <input type="text" id="genre" name="genre" class="form-control" placeholder="Podaj gatunek gry!">
                        {!! $errors->first('genre', '<p class="help-block">:message</p>') !!}
                    </div>
                    <div class="form-group{{ ($errors->has('link')) ? $errors->first('link') : '' }}">
                        <label for="link">Link</label>
                        <input type="url" id="link" name="link" class="form-control" placeholder="Podaj link do materiałów odnośnie gry">
                        {!! $errors->first('link', '<p class="help-block">:message</p>') !!}
                    </div>
                    <div class="form-group{{ ($errors->has('img_src')) ? $errors->first('img_src') : '' }}">
                        <label for="img_src">Adres url obrazka</label>
                        <input type="url" id="img_src" name="img_src" class="form-control" placeholder="Podaj adres url obrazka">
                        {!! $errors->first('link', '<p class="help-block">:message</p>') !!}
                    </div>
